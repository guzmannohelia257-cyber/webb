...
[
  {
    ...
    "latitud": null,
    "longitud": null,
    "created_at": "2026-04-18T22:56:46.115323"
  },
  {
    "id_tecnico": 2,
    "id_taller": 1,
...
- `disponible`: true/false para disponibilidad
...
export class TecnicosListComponent implements OnInit {
  ...
  editarTecnico(tecnico: any): void {
    ...
    this.loading = true;
    this.tallerService.editarTecnico(tecnico.id_tecnico, { nombre }).subscribe({
      next: (data) => {
        const index = this.tecnicos.findIndex(t => t.id_tecnico === tecnico.id_tecnico);
